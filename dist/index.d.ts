...
export declare const format: ({ value, currency, precision, si, locale, noSymbol }: IMonetochkaFormat) => string;
...
declare const _default: {
    ...
    format: ({ value, currency, precision, si, locale, noSymbol }: IMonetochkaFormat) => string;
